...
import com.sanfriend.launcher4.AutoInstallsLayout.LayoutParserCallback;
...
import com.sanfriend.launcher4.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as Launcher4 never supported a lower
                // version of the DB.
                case 12: {
